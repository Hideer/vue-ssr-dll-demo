...
var inject = _interopDefault(require('@wanwu/inject-script'));
...
var WxSdk = {
  ...
  initializeConfig: function initializeConfig() {
    ...
    this.wxConfigBatch = baseFn.fn.debounce(this.wxConfig.bind(this), 500, false); // iOS中只有验证失败的时候，需要重新验证

    if (baseFn.ua.isIOS() && this._isWxReady !== null) {
