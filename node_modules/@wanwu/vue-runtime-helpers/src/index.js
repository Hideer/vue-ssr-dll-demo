function normalizeComponent(
    ...
    let hook;
    const isPrerender = window && window.__PRERENDER__
...
const createInjectorSSRLocal = createInjectorSSR;
    ...
    if (!style.ids.includes(id)) {
        ...
        if (process.env.NODE_ENV !== "production" && css.map) {
            ...
            code +=
                "\n/*# sourceMappingURL=data:application/json;base64," +
                Buffer.from(
                    unescape(encodeURIComponent(JSON.stringify(css.map)))
                ).toString("base64") +
                " */";
        }
        style.css += code + "\n";
...
export {
    ...
    createInjector,
    createInjectorSSR,
    createInjector$1 as createInjectorShadow,
};
