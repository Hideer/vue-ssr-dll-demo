...
, shadowMode, createInjector, createInjectorSSR, createInjectorShadow) {
  ...
  var hook;
  var isPrerender = window && window.__PRERENDER__;

  if (moduleIdentifier || isPrerender) {
    if (isPrerender) {
      createInjectorSSR = createInjectorSSRLocal;
    } // server build
...
var createInjectorSSRLocal = createInjectorSSR;
...
export { createInjector, createInjectorSSR, createInjector$1 as createInjectorShadow, normalizeComponent };
