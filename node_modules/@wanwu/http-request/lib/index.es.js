...
import { generateUUID, getWebUmidToken, getUUID } from '@wanwu/mall-web-config';
...
var __env = fn.getQueryString('__env') || 'prod';

var mockUser = fn.getQueryString('mock_user') || '';
var mock = fn.getQueryString('mock') || '';
var kl_debug_params_str = fn.getQueryString('kl_debug_params') || '';
...
export { cancel, initSource, httpClientInstance as kl_request, httpBaseInstance as kl_request_base, ver };
