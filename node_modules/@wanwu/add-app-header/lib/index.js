...
var locationPluginThroughParams = require('@wanwu/location-plugin-through-params');
...
var isAPP = baseFn.ua.getAppName() === 'wwdz_b2b' || baseFn.fn.isLargerThanAppVersion('2.7.7');
/** 是否在app的弹窗内 */

var isEmbed = baseFn.fn.getQueryString('isEmbed');
/** 是否需要展示app头部 */
...
var script = {
  ...
  methods: {
    ...
    clickFn: function clickFn(btnFn) {
      ...
      if (btnFn === 'back') {
        baseFn.ua.isApp() ? hdp.execRequest('PluginNavigation', 'pageFinish') : this.$location.back();
      }
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                // 获取各个手机的状态栏
                nh = baseFn.fn.getQueryString('__nhDP') * 2 || baseFn.fn.getQueryString('__nh');
                this.getUaNh();
    ...
    setNh: function setNh() {
      ...
      if (baseFn.ua.getAppName() === 'wwdz_b2b' || baseFn.fn.isLargerThanAppVersion('3.1.8')) {
        if (baseFn.ua.isIOSApp()) {
          NumberNh = NumberNh * 2;
        }
      } else {
        if (baseFn.ua.isIOSApp()) {
          NumberNh = NumberNh + 10;
        } else if (baseFn.ua.isAndroidApp() && Number(nh)) {
...
locationPluginThroughParams.addThroughParams('__nh');
var cacheEvents;
...
function addAppHeader(_ref) {
  ...
  if (needShowAppHeader) {
    if (!exports.appHeader) {
      exports.appHeader = new AppHeaderConstructor();
      exports.appHeader.vm = exports.appHeader.$mount();
      document.body.prepend(exports.appHeader.vm.$el);
    }

    eventUtils.vmUnbindEvents(exports.appHeader, cacheEvents);
    Object.assign(exports.appHeader.$props, defaultOptions);

    if (props) {
      Object.assign(exports.appHeader.$props, props);
    }

    if (events) {
      cacheEvents = events;
      eventUtils.vmBindEvents(exports.appHeader, cacheEvents);
    }

    exports.appHeader.$scopedSlots = {};

    if (slots) {
      Object.assign(exports.appHeader.$scopedSlots, slots);
    } // 隐藏头部
    ...
    if (isIgnoreHeader) {
      exports.appHeader.hide();
    } else {
      exports.appHeader.show();
      exports.appHeader.setPublicHeaderHeight();

      if (isHasShareHeader) {
        exports.appHeader.showAppHeaderShare();
      } else {
        exports.appHeader.hideAppHeaderShare();
      }
    }
  }

  return exports.appHeader;
}
/**
 * 公用校验路径的方法
...
exports.addAppHeader = addAppHeader;
exports.checkHasPath = checkHasPath;
exports.isAPP = isAPP;
exports.isDevelopment = isDevelopment;
exports.isEmbed = isEmbed;
exports.needShowAppHeader = needShowAppHeader;
