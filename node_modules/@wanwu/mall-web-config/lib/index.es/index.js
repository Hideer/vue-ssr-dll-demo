...
var getCurrentPlatformType = function getCurrentPlatformType() {
  var appPlatform = ua.getAppPlatform();
  var res;
...
var getSource = function getSource() {
  var appPlatform = ua.getAppPlatform(); // getAppVersion()：获取应用版本信息

  var appVersion = ua.getAppVersion() || '0.0.1';
...
export { generateUUID, getConstID, getCurrentPlatformType, getSource, getUAToken, getUUID, getWebUmidToken };
