...
var script = {
  ...
  methods: {
    ...
    onResize: function onResize() {
      ...
      setTimeout(function () {
        _this.initialize(_this.activeIndicator);
      });
    },
    ...
    move: function move(_ref2) {
      ...
      var num = Math.round(offset - this.active * this.size);
    ...
    swipeTo: function swipeTo(index) {
      ...
      setTimeout(function () {
        ...
        _this2.move({
          pace: index % _this2.count - _this2.active,
...
var __vue_inject_styles__ = function __vue_inject_styles__(inject) {
  if (!inject) return;
  inject("data-v-113260b0_0", {
    source: ".component__swipe[data-v-113260b0]{overflow:hidden;position:relative;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.component__swipe .swipe__track[data-v-113260b0]{height:100%}.component__swipe .swipe__indicator[data-v-113260b0]{opacity:.3;border-radius:50%;width:.1rem;height:.1rem;transition:opacity .2s;background-color:#d8d8d8}.component__swipe .swipe__indicator[data-v-113260b0]:not(:last-child){margin-right:.1rem}.component__swipe .swipe__indicator--active[data-v-113260b0]{opacity:1;background-color:#ea313e}.component__swipe .swipe__indicators[data-v-113260b0]{display:flex;position:absolute;left:50%;bottom:.1rem;transform:translateX(-50%)}.component__swipe .swipe__indicators--vertical[data-v-113260b0]{left:.1rem;top:50%;bottom:auto;flex-direction:column;transform:translateY(-50%)}.component__swipe .swipe__indicators--vertical .swipe__indicator[data-v-113260b0]:not(:last-child){margin-bottom:.1rem}",
    map: undefined,
    media: undefined
  });
};
...
var __vue_scope_id__ = "data-v-113260b0";
/* module identifier */
...
export { __vue_component__ as Swipe, __vue_component__$1 as SwipeItem };
