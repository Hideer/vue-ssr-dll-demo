...
var baseVueShareDialog = require('@wanwu/base-vue-share-dialog');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 11:
            ...
            inviteCode = User.getUserInfo().inviteCode || baseFn.fn.getQueryString('inviteCode'); // return axios.post('https://api.wanwudezhi.com/media/xcx/getWxCode', {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            shareType = pushTarget === 'xcx';
            shareOptions = Share.getCacheShareOptions(shareOptions);
            inviteCode = User.getUserInfo().inviteCode || baseFn.fn.getQueryString('inviteCode');
            _context2.prev = 4;
            _context2.next = 7;
            return resourceCenter.activeGoodsType();
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 14:
            ...
            _context3.prev = 15;
            _context3.next = 18;
            return baseVueShareDialog.getShortChain(shareOpt);

          case 18:
            shortLink = _context3.sent;
            return _context3.abrupt("return", QRCode.toDataURL(shortLink, style || {}));
...
exports.default = getH5Code;
exports.getH5Code = getH5Code;
exports.getQrCodeByStyle = getQrCodeByStyle;
exports.getShareCodeImg = getShareCodeImg;
exports.getXcxCode = getXcxCode;
