...
var crypto = require('@wanwu/crypto');
var webConfig = require('@wanwu/mall-web-config');
var webConfig__default = _interopDefault(webConfig);
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              deviceinfo = 'h5';
              if (baseFn.ua.isIOSApp()) deviceinfo = 'iOS';
              if (baseFn.ua.isAndroidApp()) deviceinfo = 'Android';
              if (baseFn.ua.isWechatMiniProgram()) deviceinfo = 'xcx';
              appversion = baseFn.ua.getAppVersion() || AppVersion;
              systemversion = '1.0.0';
            ...
            case 18:
              ...
              _context.prev = 21;
              _context.next = 24;
              return webConfig.getWebUmidToken();
            ...
            case 31:
              ...
              if (token && !config.withoutToken) {
                config.headers.common[webConfig__default.AuthorizationKey] = token;
              }

              if (config.encrypt) {
                if (typeof data !== 'undefined') {
                  originText = JSON.stringify(data);
                  cipherText = crypto.encrypt(originText);
                  config.data = {
              ...
              __env = baseFn.fn.getQueryString('__env');
...
exports.tokenManager = baseSdkTokenManager;
exports.Axios = Request;
exports.axios = axios;
exports.cancel = cancel;
exports.default = instance;
exports.h5_axios = instance;
