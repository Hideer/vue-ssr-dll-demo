...
export default function logE(eventId: any, data: any, nowReport?: boolean) {
  ...
  let loggerInfo: LoggerInfoTypes = {};
  // 定义对象
  let obj: any;
  if (eventId == "listShow") {
    obj =
  ...
  // 定义产生rtpRefer事件
  let event: any = ["listClick", "elementClick", "dialogClick", "videoSwitch"];
  // 新的埋点上报方法
...
//   loggerInfo.refer = _refer;
  ...
  loggerInfo.ext = { ...data, ...loggerInfo.ext };
  // 检查list类埋点数据格式
