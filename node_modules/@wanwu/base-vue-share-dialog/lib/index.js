...
var Occupying = _interopDefault(require('@wanwu/base-vue-occupying'));
var baseFn = require('@wanwu/base-fn');
var Share = _interopDefault(require('@wanwu/base-share'));
var copyText = _interopDefault(require('@wanwu/copy-text'));
var Dialog = _interopDefault(require('@wanwu/base-vue-dialog'));
var hdp = _interopDefault(require('@wanwu/hdp'));
var User = _interopDefault(require('@wanwu/base-user'));
var resourceCenter = require('@wanwu/resource-center');
var baseVueToast = require('@wanwu/base-vue-toast');
var baseLogger = require('@wanwu/base-logger');
var mySentry = _interopDefault(require('@wanwu/sentry'));
var request = _interopDefault(require('@wanwu/base-request'));
var vueRuntimeHelpers = require('@wanwu/vue-runtime-helpers');
var Vue = _interopDefault(require('vue'));
var canvas2image = require('@wanwu/canvas2image');
    ...
    showBtn: {
      ...
      "default": function _default() {
        return {
          wxim: 4,
          // 分享好友
          yjfq: baseFn.ua.isApp() && 4,
          // 一件发圈
          copy: true,
          // 复制链接
          saveImg: true,
          // '保存图片' : '生成海报',
          qq: baseFn.ua.isApp() && baseFn.fn.compareVersion(baseFn.ua.getAppVersion(), '2.5.1') >= 0,
          // 分享qq
          wb: baseFn.ua.isApp() && baseFn.fn.compareVersion(baseFn.ua.getAppVersion(), '2.5.1') >= 0,
          // 分享weibo ,
          h5saveImg: !baseFn.ua.isApp() // h5保存图片提示
    ...
    btnListObj: function btnListObj() {
      ...
      return {
        ...
        saveImg: {
          ...
          text: baseFn.ua.isApp() ? '保存图片' : '生成海报',
          method: this.saveImg
        },
        h5saveImg: {
          key: 'h5saveImg',
  ...
  methods: {
    ...
    copyLink: function copyLink() {
      ...
      copyText(link).then(function (res) {
        baseVueToast.toast('链接复制成功');
      })["catch"](function (err) {
        baseVueToast.toast(err.message);
      });
      /**
       * 用户点击底部分享按钮后触发
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 4;
                _context.next = 7;
                return resourceCenter.activeGoodsType();
              ...
              case 14:
                ...
                canTailoring = shareObj.imgUrl.indexOf('cdn.wanwudezhi') > -1 && !(baseFn.ua.isIOSApp() && shareObj.imgUrl.indexOf('vframe') > -1);
                ...
                return _context.abrupt("return", hdp.exec('PluginShare', 'wechat', {
                  ...
                  mediaObject: {
                    ...
                    miniprogramType: parseInt(baseFn.fn.getQueryString('__miniprogramType')) || 0,
                    // 小程序的类型
                    hdImageData: imgUrl
                  }
                }));
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 7:
                ...
                this.$location.push(baseFn.fn.stringifyUrl('/webview/share', {
    ...
    checkIsProcessToWechatMiniProgram: function checkIsProcessToWechatMiniProgram() {
      var xcxVersion = baseFn.fn.getQueryString('xcxVersion');
      return baseFn.ua.isWechatMiniProgram() && xcxVersion && baseFn.fn.compareVersion(xcxVersion, '2.0.62') >= 0;
    },
    genShareLink: function genShareLink(_ref3) {
      var shareTitle = _ref3.shareTitle,
          needTitle = _ref3.needTitle,
          _short = _ref3["short"];
      var link = baseFn.fn.setQueryString(_short ? this.shareLinkShort : this.cntShareObj.link, 'shareTitle', shareTitle);
...
var ShareDialog = /*#__PURE__*/function () {
  ...
  _createClass(ShareDialog, [{
      ...
      if (options) {
        ...
        if (options.props) {
          ...
          if (Array.isArray(showBtn)) {
            ...
            showBtnObj['saveImg'] = baseFn.ua.isApp();
    ...
    value: function drawImg(config) {
      return canvas2image.drawImage(config);
    }
    /**
     * 保存图片
...
function getdefault(compObj) {
  var Obj = {};
  var props = baseFn.fn.getObjDeepValue(compObj, 'props');
  props && Object.keys(props).forEach(function (prop) {
    var prorDefault = baseFn.fn.getObjDeepValue(props, prop + '.default');

    if (baseFn.fn.typeYalidator.isFunction(prorDefault)) {
...
exports.getShortChain = _getShortChain;
exports.shareDialog = shareDialog;
exports.shareDialogDefaultProps = defaultProps;
