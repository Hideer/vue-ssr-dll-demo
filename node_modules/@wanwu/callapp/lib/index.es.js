...
import { setQueryString, stringifyUrl } from '@wanwu/base-fn/lib/fn/index';
            ...
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                if (this.isAndroidWechat && !this.abGuideMask || !this.middleCallPage) {
                  ...
                  url = setQueryString(this.middleCallPage, 'called', true);
                  evokeByLocation(url);
                }
    ...
    value: function preHandleConfig(config) {
      ...
      if (browser.isIos) {
        ...
        if (path !== 'openApp' && path !== 'splash') {
          ...
          var jumpUrl = encodeURIComponent(stringifyUrl("".concat(protocol, "://").concat(host, "/").concat(path), param));
          return {
            path: 'openApp',
            param: {
              jumpUrl: jumpUrl
