...
var RS = _interopDefault(require('@wanwu/resource-center'));
var envUtils = require('@wanwu/env-utils');
var CallApp = _interopDefault(require('@wanwu/callapp'));
...
var defaultRules = [{
  ...
  h5Prevent: true,
  callback: function callback(to) {
    if (baseFn.ua.isIOSApp() && baseFn.fn.compareVersion(baseFn.ua.getAppVersion(), '2.2.9') === 0) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (!(!baseFn.ua.isApp() && !baseFn.ua.isWechatMiniProgram() && options.callApp)) {
              _context.next = 17;
              break;
            }
            ...
            _context.prev = 5;
            _context.next = 8;
            return convertUrlFromH5ToCallapp(baseFn.fn.clone(to), options);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 10:
            ...
            _context3.next = 13;
            return WxSdk.wxMiniProgramRedirectTo(baseFn.fn.stringifyUrl(path, query));
          ...
          case 15:
            _context3.next = 17;
            return WxSdk.wxMiniProgramNavigateTo(baseFn.fn.stringifyUrl(path, query));
        ...
        switch (_context4.prev = _context4.next) {
          ...
          case 10:
            ...
            return hdp.exec('PluginRouter', 'jumpApp', {
              linkUrl: baseFn.fn.stringifyUrl(path, query)
            });
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 27:
            ...
            to.query = processMappingQuery(queryRule, queryValueMap, baseLogger.addReferRtp(location.href, baseFn.fn.clone(query)));
            return _context5.abrupt("return", to);
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 5:
            ...
            if (appUrl) {
              jumpUrl = baseFn.fn.stringifyUrl('zdwh://wwdz' + appUrl, processMappingQuery(queryRule, queryValueMap, baseLogger.addReferRtp(location.href, baseFn.fn.clone(to.query))));
            } else {
              jumpUrl = baseFn.fn.stringifyUrl("".concat(to.origin || '').concat(to.base && to.base !== '/' ? to.base : '').concat(to.path || ''), to.query) + (to.hash ? "#".concat(to.hash) : '');
            }
        ...
        switch (_context11.prev = _context11.next) {
          ...
          case 2:
            ...
            if (to.path === 'zdwh://wwdz/flutter/page') {
              key = baseFn.fn.stringifyUrl(to.path, {
        ...
        switch (_context12.prev = _context12.next) {
          case 0:
            if (!_routerRulesCache) {
              _routerRulesCache = RS.getList(envUtils.isApiDev() ? 468 : 81, false).then(function (res) {
...
function sortByMinVersion(a, b) {
  ...
  return -baseFn.fn.compareVersion(aMinVersion, bMinVersion);
} // 根据最高版本号比较 sort比较函数
...
function sortByMaxVersion(a, b) {
  ...
  return baseFn.fn.compareVersion(aMaxVersion, bMaxVersion);
} // 获取规则最低版本号


function getMinVersion(rule) {
  var isAndroidApp = baseFn.ua.isAndroidApp();
...
function processMappingQuery(queryKeyRule, queryValueMap, query) {
  var newQuery = baseFn.fn.clone(query);
...
function checkMinVersion(config) {
  return baseFn.fn.compareVersion(baseFn.ua.getAppVersion(), getMinVersion(config)) >= 0;
} // 比较app版本是否符合规则最高版本限制


function checkMaxVersion(config) {
  return baseFn.fn.compareVersion(baseFn.ua.getAppVersion(), getMaxVersion(config)) <= 0;
}
...
function replace(to, from, prevent, eventCenter, options) {
  ...
  } else if (baseFn.ua.isWechatMiniProgram() || WxSdk._isMiniProgram) {
...
exports.PREVENTCODE = PREVENTCODE;
