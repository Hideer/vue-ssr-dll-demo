...
var axios = _interopDefault(require('@wanwu/http-request'));
...
function get(resourceId) {
  ...
  return multiGet([resourceId], options).then(function (res) {
    return baseFn.fn.getObjDeepValue(res, '0.detail.0');
  });
}
/**
 * 获取单个资源位的所有数据
...
function getList(resourceId) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return multiGet([resourceId], options).then(function (res) {
    return baseFn.fn.getObjDeepValue(res, '0.detail');
  });
}
/**
 * 获取高分佣相关资源位 id 59
...
exports.activeGoodsType = activeGoodsType;
exports.appraiserResource = appraiserResource;
exports.bottomResource = bottomResource;
exports.clearCache = clearCache;
exports.default = index;
exports.get = get;
exports.getList = getList;
exports.globalApiConfig = globalApiConfig;
exports.highCommissionResource = highCommissionResource;
exports.multiGet = multiGet;
exports.qqtpsResource = qqtpsResource;
