...
function isToControlVersion() {
  return !['wwdz_b2b'].includes(ua.getAppName());
}
...
function inject() {
  ...
  if (ua.isIOSApp() && isToControlVersion() && fn.compareVersion(ua.getAppVersion(), '2.2.0') < 0) {
...
var isApp = ua.isApp,
    isIOSApp = ua.isIOSApp,
    isAndroidApp = ua.isAndroidApp;
