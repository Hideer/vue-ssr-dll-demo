...
var _typeof = _interopDefault(require('@babel/runtime/helpers/esm/typeof'));
...
var EMPTY = '';
var UNKNOWN = '?';
var FUNC_TYPE = 'function'; // var UNDEF_TYPE = 'undefined';
...
var mapper = {
  rgx: function rgx(ua, arrays) {
    ...
    var q;
    var matches;
    var match; // loop through all regexes maps
...
var regexes = {
  ...
  wwdz: [[/(wwdz)\/([\w\.]+)/i // 玩物得志app
  ], [NAME, VERSION], [/miniProgram/i // 微信小程序
  ], [[NAME, 'xcx']]]
}; /// //////////////
// Constructor
/// /////////////
...
var UAParser = function UAParser(uastring, extensions) {
  ...
  this.getWwdz = function () {
    var wwdz = {
      name: undefined,
      version: undefined
    };
    mapper.rgx.call(wwdz, ua, rgxmap.wwdz);
    wwdz.major = util.major(wwdz.version);
    return wwdz;
  };
