...
function inject() {
  ...
  if (ua.isIOSApp() && fn.compareVersion(ua.getAppVersion(), '2.2.0') < 0) {
...
function exec(service, action) {
  ...
  return new Promise(function (resolve, reject) {
    if (isIOSApp() && fn.compareVersion(ua.getAppVersion(), '2.2.0') < 0) {
...
if (fn.compareVersion(ua.getAppVersion(), '2.1.5') < 0) {
