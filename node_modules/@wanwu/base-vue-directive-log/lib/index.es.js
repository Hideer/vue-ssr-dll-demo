...
var isDebug = fn.getQueryString('__debug'); // 获取在可视区范围内的位置
...
var LogScroll = /*#__PURE__*/function () {
  function LogScroll(props) {
    ...
    this.onScrollEvent = fn.throttle(this.onScroll.bind(this), 200);
    this.onListenScroll();
...
var isDebug$1 = fn.getQueryString('__debug');
...
export default ExposureLogDirective;
