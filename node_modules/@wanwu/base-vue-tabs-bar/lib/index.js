...
var ButtonX = _interopDefault(require('@wanwu/base-vue-bottom-x'));
var Badge = _interopDefault(require('@wanwu/base-vue-badge'));
...
var script = {
  ...
  methods: {
    ...
    getBottomConfig: function getBottomConfig() {
      ...
      // bottomResource
      resourceCenter.bottomResource().then(function (res) {
  ...
  computed: _objectSpread({}, vuex.mapState('community', ['socialCount'])),
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _this3.isIPhoneX = baseFn.ua.isIPhoneX(); // 这期暂时注释，先走本地数据
