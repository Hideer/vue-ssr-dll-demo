...
import { initLogger, getRouteLocation } from '@wanwu/base-mall-logger';
...
import { cancel } from '@wanwu/base-request';
import { getToken, saveToken, removeToken } from '@wanwu/base-sdk-token-manager';
...
var User = /*#__PURE__*/function () {
  ...
  _createClass(User, [{
    key: "getToken",
    value: function getToken$1() {
      return getToken(this.option.loginOption.getTokenOnUrl);
    }
    /**
     *  批量修改模块全局配置，使用merge
    ...
    value: function loginByPhone(phone, code) {
      var inviteCode = fn.getQueryString('inviteCode'); // const { sig, csessionid } = nc_data;
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                wechatTransformUrlRedirect = getRouteLocation(loginOrigin + wechatTransformUrl, _objectSpread({
                ...
                loginUrl = getRouteLocation(xcxLoginUrl, _objectSpread({
              ...
              case 19:
                if (!(ua.isWechat() && location.host !== 'dev-h5.wanwudezhi.com')) {
                  _context8.next = 34;
                  break;
                }
    ...
    value: function redirectBack() {
      var redirectUrl = fn.getQueryString('redirectUrl');
