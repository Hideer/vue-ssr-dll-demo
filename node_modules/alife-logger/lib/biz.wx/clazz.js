var util = require("../util"), MiniProgramLogger = require("../miniProgramLogger"), ARMS_STORAGE_MINIPROGRAM_WX_UID_KEY = "ARMS_STORAGE_MINIPROGRAM_WX_UID_KEY", WXLogger = function(e) {
    return MiniProgramLogger.call(this, e), this.initPerfObserver(), this;
};
...
WXLogger.prototype = util.createObject(MiniProgramLogger.prototype), util.ext(MiniProgramLogger._root.dftCon, {
    ...
    initPerfObserver: function() {
        var e = this;
        if ("object" == typeof wx && wx && "function" == typeof wx.getPerformance) {
            e.sendOncePerf = function() {};
            try {
                wx.getPerformance().createObserver(function(t) {
                    var r = t.getEntries(), o = {};
                    if (Array.isArray(r) && r.length > 0) for (var n = 0; n < r.length; n++) {
                        var i = r[n];
                        switch (i.name) {
                          case "appLaunch":
                            o.launch = i.duration;
                    ...
                    Object.keys(o).length > 0 && e._lg("perf", o, e.getConfig("sample"));
                }).observe({
                    entryTypes: [ "navigation", "render" ]
                });
            } catch (t) {
                util.warn("[ARMS] initPerfObserver error :", t);
            }
        }
    },
    hookApp: function(e) {
        var t = this, r = {
            ...
            onLaunch: function() {
                var r = 1 === arguments.length ? [ arguments[0] ] : Array.apply(null, arguments), o = e.onLaunch;
                try {
                    t.appLaunch();
                } catch (n) {
